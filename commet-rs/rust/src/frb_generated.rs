...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2066541298;
...
fn wire__crate__api__livekit__livekit_session_manager__livekit_session_reference_start_screenshare_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "livekit_session_reference_start_screenshare", port: None, mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <crate::api::livekit::livekit_session_manager::LivekitSessionReference>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse::<_, ()>((move || {
                     let output_ok = Result::<_,()>::Ok({ crate::api::livekit::livekit_session_manager::LivekitSessionReference::start_screenshare(&api_that); })?;   Ok(output_ok)
                })()) })
}
...
3 => wire__crate__api__livekit__livekit_session_manager__livekit_session_reference_start_screenshare_impl(ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
