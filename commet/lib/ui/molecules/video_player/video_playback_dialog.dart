...
class VideoPlaybackDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double maxWidth = isVertical ? 420.0 : 1000.0;
    final double maxHeight = isVertical
              ...
              child: Padding(
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Video Player Container with dynamic AspectRatio
                      Flexible(
                        child: AspectRatio(
                          aspectRatio: aspect,
                          child: ClipRRect(
    ...
    return Stack(
      ...
      children: [
        InAppWebView(
          ...
          initialUrlRequest: URLRequest(url: WebUri(playbackUri.toString())),
          ...
          shouldOverrideUrlLoading: (_, navigationAction) async {
            ...
            final sourceHost = widget.source.uri.host.toLowerCase();

            // Allow navigation within provider's embed domain
            if (targetHost == sourceHost ||
                targetHost.endsWith('.youtube.com') ||
                targetHost.endsWith('.youtube-nocookie.com') ||
                targetHost.endsWith('.instagram.com')) {
              return NavigationActionPolicy.ALLOW;
            }

            // Outside navigation is cancelled or opened in browser
